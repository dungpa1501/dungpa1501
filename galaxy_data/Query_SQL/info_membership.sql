-- Query Point user theo time range
...
FROM
	...
	--and membership_id = @memberid -- bỏ comment để check từng user
	group by 	
	transaction_posUserid,
	membership_id,
	person_email,
	...
	order by point_used desc
	


-- Query detail từng Transaction từng user
